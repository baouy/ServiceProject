    ...
    $(document).on(BJUI.eventType.initUI, function(e) {
        ...
        $box.find('.zjoin-filter').bind('focus',function(){
            ...
            if( $this.parent('th').find('div').length>0){
                ...
                var zindex =3;
                if(layer.zIndex) zindex=layer.zIndex+1;

                var $div = $('<div class="zjoin-filter-box" style="width:'+($this.width()+3)+'px;top:'+($this.offset().top+$this.height()+4)+'px;left: '+$this.offset().left+'px;z-index:'+zindex+';"></div>');
