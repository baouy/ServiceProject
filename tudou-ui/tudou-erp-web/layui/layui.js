...
;!function (win) {
    ...
    var doc = document, config = {
        ...
        , modules = {
            ...
            , cookie: 'modules/cookie' //表单验证
            , ztree: 'modules/plugin/ztree/ztree' //表单验证
            , ztreecheck: 'modules/plugin/ztree/ztreecheck' //表单验证
            , ztreeedit: 'modules/plugin/ztree/ztreeedit' //表单验证
            , fontpicker: 'modules/plugin/fontpicker/fontpicker' //表单验证
