package com.tudou.upms.rpc.service;
...
//        System.out.println(upmsUser.getUserId());
        ...
        upmsOrganization.setName("测试1");
        upmsOrganization.setDescription("测试2");
        upmsOrganization.setCtime(System.currentTimeMillis());

        upmsOrganizationService.insertSelective(upmsOrganization);
        System.out.println(upmsOrganization.getOrganizationId());
    }
