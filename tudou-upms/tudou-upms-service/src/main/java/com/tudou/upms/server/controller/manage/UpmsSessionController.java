...
public class UpmsSessionController extends BaseController{
	...
	@ResponseBody
	public Object list(
	@RequestParam(required = false, defaultValue = "1", value = "pageCurrent") int offset,
	@RequestParam(required = false, defaultValue = "50", value = "pageSize") int limit) {
		return sessionDAO.getActiveSessions((offset - 1) * limit, limit);
	}
